		...
		<form>
			<fieldset>
				...
				<div class='form-group'>
					...
					<input type='number' name='AliqPis' id='AliqPis' class='form-control' placeholder='' required>
				</div>
				<div class='form-group'>
					<label for='AliqCofins'></label>
					<input type='number' name='AliqCofins' id='AliqCofins' class='form-control' placeholder='' required>
				</div>
