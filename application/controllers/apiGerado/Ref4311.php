...
/*
	<header class='page-title-bar'>
		<legend>Produtos Sujeitos a Alíquotas por Unidade de Medida de Produto</legend>
	</header>
	<div class='page-section'>
		<div class='section-block'>
			<div class='card' id='floating-label'>
				<div class='card-body'>
					<?= form_open(base_url('ref4311/')) ?>
						<fieldset>
							...
							<div class='form-group'>
								...
								<input type='text' name='Unid' id='Unid' class='form-control' placeholder='Unidade' >
								<?php if(isset($response)): ?>
									<div class='invalid-feedback' style='display:block'><?= isset($response->error->Unid) ? $response->error->Unid : ''; ?></div>
								<?php endif; ?>
							</div>
							<div class='form-group'>
