					...
					<?= form_open(base_url('regs0400efdc/')) ?>
						<fieldset>
							...
							<div class='form-group'>
								...
								<?php if(isset($response)): ?>
									<div class='invalid-feedback' style='display:block'><?= isset($response->error->CodNat) ? $response->error->CodNat : ''; ?></div>
								<?php endif; ?>
							</div>
							<div class='form-group'>
								...
								<?php if(isset($response)): ?>
									<div class='invalid-feedback' style='display:block'><?= isset($response->error->DescricaoNat) ? $response->error->DescricaoNat : ''; ?></div>
								<?php endif; ?>
							</div>
							<div class='form-group'>
