...
class Regs0600efdc extends MY_Controller {
  ...
  public function  __construct() {
    ...
    $this->joins = [
			['table' => 'pessoasjuridica', 'condition' => 'pessoasjuridica.Id = regs0600efdc.PessoaJuridicaId', 'type' => 'left'],
    ];
  }
					...
					<?= form_open(base_url('regs0600efdc/')) ?>
						<fieldset>
							...
							<div class='form-group'>
								...
								<?php if(isset($response)): ?>
									<div class='invalid-feedback' style='display:block'><?= isset($response->error->CodCCusto) ? $response->error->CodCCusto : ''; ?></div>
								<?php endif; ?>
							</div>
							<div class='form-group'>
								...
								<?php if(isset($response)): ?>
									<div class='invalid-feedback' style='display:block'><?= isset($response->error->NomeCCusto) ? $response->error->NomeCCusto : ''; ?></div>
								<?php endif; ?>
							</div>
							<div class='form-group'>
