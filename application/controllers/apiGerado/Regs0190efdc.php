...
class Regs0190efdc extends MY_Controller {
  ...
  public function  __construct() {
    ...
    $this->joins = [
			['table' => 'pessoasjuridica', 'condition' => 'pessoasjuridica.Id = regs0190efdc.PessoaJuridicaId', 'type' => 'left'],
    ];
  }
	...
	<div class='page-section'>
		<div class='section-block'>
			<div class='card' id='floating-label'>
				<div class='card-body'>
					<?= form_open(base_url('regs0190efdc/')) ?>
						<fieldset>
							...
							<div class='form-group'>
								...
								<?php if(isset($response)): ?>
									<div class='invalid-feedback' style='display:block'><?= isset($response->error->Unidade) ? $response->error->Unidade : ''; ?></div>
								<?php endif; ?>
							</div>
							<div class='form-group'>
								...
								<?php if(isset($response)): ?>
									<div class='invalid-feedback' style='display:block'><?= isset($response->error->Descrição) ? $response->error->Descrição : ''; ?></div>
								<?php endif; ?>
							</div>
							<div class='form-group'>
