...
class Pessoasjuridica extends MY_Controller {
  ...
  public function create(){
    $this->form_validation->set_rules('pj_Nome', 'pj_Nome', 'required|max_length[450]');
		...
		$this->form_validation->set_rules('pj_MunicipioId', 'pj_MunicipioId', 'required|integer');
		$this->form_validation->set_rules('pj_PessoaFisicaId', 'pj_PessoaFisicaId', 'required|integer');
