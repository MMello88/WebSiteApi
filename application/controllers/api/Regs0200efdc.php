...
class Regs0200efdc extends MY_Controller {
  ...
  public function  __construct() {
    ...
    $this->joins = [
			['table' => 'regs0190efdc', 'condition' => 'regs0190efdc.0190_Id = regs0200efdc.Reg0190EFDCId', 'type' => 'left'],
			['table' => 'pessoasjuridica', 'condition' => 'pessoasjuridica.pj_Id = regs0200efdc.PessoaJuridicaId', 'type' => 'left'],
			['table' => 'regs0205efdc', 'condition' => 'regs0205efdc.0205_Id = regs0200efdc.Reg0205EFDCId', 'type' => 'left'],
			['table' => 'regs0206efdc', 'condition' => 'regs0206efdc.0206_Id = regs0200efdc.Reg0206EFDCId', 'type' => 'left'],
			['table' => 'regs0208efdc', 'condition' => 'regs0208efdc.0208_Id = regs0200efdc.Reg020EFDCId', 'type' => 'left'],
    ];
  }
